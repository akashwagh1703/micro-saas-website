/** Detailed Privacy Policy & Terms of Use for WhatsFlow */

export const privacyPolicy = {
  title: 'Privacy Policy',
  updated: 'May 30, 2026',
  intro:
    'WhatsFlow ("we", "us", "our") operates the WhatsFlow platform at whatsflow.in and related applications (the "Service"). This Privacy Policy explains how we collect, use, store, and protect your information when you use our Service. By registering or using WhatsFlow, you agree to this policy.',
  sections: [
    {
      id: 'who-we-are',
      title: '1. Who we are',
      paragraphs: [
        'WhatsFlow is a software platform that helps small businesses automate WhatsApp customer conversations using auto-reply workflows, an inbox, and contact management.',
        'For privacy-related questions, contact us at hello@whatsflow.in or through the Contact page on our website.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'We use collected information solely to operate and improve WhatsFlow:',
      ],
      list: [
    ...
    },
    {
      ...
      paragraphsAfter: [
        'To exercise these rights, email hello@whatsflow.in with your registered email address. We will respond within 30 days.',
      ],
    },
    {
      id: 'customer-data',
      ...
      paragraphs: [
        'When you use WhatsFlow, you may process personal data of your WhatsApp customers (phone numbers, names, message content). You are the data controller for that data; WhatsFlow acts as a data processor on your instructions to deliver auto-replies and inbox features.',
    ...
    },
    {
      ...
      paragraphs: [
        'The WhatsFlow web application (portal) uses local storage and session tokens to keep you logged in. Our marketing website may use essential cookies for basic functionality.',
    ...
    },
    {
      ...
      paragraphs: [
        'WhatsFlow is a business tool not intended for users under 18. We do not knowingly collect data from children. Contact us if you believe a minor has registered an account.',
      ],
    },
    {
      id: 'international',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Email: hello@whatsflow.in',
        'Website: Contact page at whatsflow.in/contact',
      ],
    },
  ],
};
...
export const termsOfUse = {
  ...
  updated: 'May 30, 2026',
  intro:
    'These Terms of Use ("Terms") govern your access to and use of the WhatsFlow platform, website, and related services ("Service") operated by WhatsFlow. Please read them carefully. By creating an account or using the Service, you agree to these Terms.',
  sections: [
    {
      id: 'acceptance',
      title: '1. Acceptance of terms',
      paragraphs: [
        'If you do not agree to these Terms, do not use the Service. If you are using WhatsFlow on behalf of a business, you represent that you have authority to bind that business to these Terms.',
      ],
    },
    {
      ...
      paragraphs: [
        'WhatsFlow provides a cloud-based platform for:',
      ],
      list: [
      ...
      paragraphsAfter: [
        'WhatsFlow is a technology platform. We do not provide WhatsApp accounts, phone numbers, or AI services directly — you obtain those from Meta and AI providers separately.',
      ],
    },
    {
      id: 'account',
      ...
      paragraphs: [
        ...
        'Notify us immediately at hello@whatsflow.in if you suspect unauthorized access. We may suspend accounts with suspicious activity.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'WhatsApp conversation charges from Meta and AI API usage from OpenRouter/OpenAI are billed separately by those providers — not included in the WhatsFlow platform fee.',
      ],
    },
    {
      ...
      list: [
        ...
        'Not use WhatsFlow for spam, harassment, fraud, illegal goods/services, or misleading content.',
    ...
    },
    {
      ...
      paragraphs: [
        'WhatsApp messaging is provided by Meta Platforms, Inc. Your use of WhatsApp through WhatsFlow is subject to Meta\'s terms, policies, and pricing.',
        'WhatsFlow is not affiliated with, endorsed by, or sponsored by Meta. Service interruptions caused by Meta API changes, outages, or account restrictions are outside our control.',
    ...
    },
    {
      ...
      paragraphs: [
        'WhatsFlow owns all rights to the platform software, design, templates, documentation, and branding. You receive a limited, non-exclusive, non-transferable license to use the Service during your subscription.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Our total liability for any claim arising from the Service shall not exceed the amount you paid to WhatsFlow in the twelve (12) months preceding the claim, or ₹5,000, whichever is greater.',
    ...
    },
    {
      ...
      paragraphs: [
        'You agree to indemnify and hold WhatsFlow harmless from claims, damages, and expenses (including reasonable legal fees) arising from: (a) your use of the Service; (b) your message content or auto-replies; (c) violation of these Terms or Meta policies; or (d) infringement of third-party rights.',
      ],
    },
    {
      id: 'termination',
      ...
      paragraphs: [
        'You may stop using the Service and request account deletion at any time by contacting hello@whatsflow.in.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'We encourage resolving disputes amicably by contacting hello@whatsflow.in before pursuing legal action.',
      ],
    },
    {
      id: 'general',
      ...
      paragraphs: [
        'These Terms, together with our Privacy Policy, constitute the entire agreement between you and WhatsFlow.',
